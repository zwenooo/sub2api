<template>
  <AppLayout>
        ...
        <div class="flex flex-wrap-reverse items-start justify-between gap-3">
          ...
          >
            ...
            <template #beforeCreate>
              <button @click="showImportOpenAIAuth = true" class="btn btn-secondary">
                {{ t('admin.accounts.openAIAuthImport') }}
              </button>
    ...
    <ImportOpenAIAuthModal :show="showImportOpenAIAuth" :groups="groups" :proxies="proxies" @close="showImportOpenAIAuth = false" @imported="handleOpenAIAuthImported" />
...
const showImportOpenAIAuth = ref(false)
