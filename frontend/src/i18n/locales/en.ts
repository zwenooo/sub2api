export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      accountRuleManager: 'Account Rules',
      openAIAutoDisableRules: 'OAI Auto Disable',
      openAIAutoDisableRulesTitle: 'OpenAI Auto Disable Rules',
      openAIAutoDisableRulesEnabled: 'Enable OpenAI auto disable rules',
      openAIAutoDisableRulesHint: 'Automatically disable an OpenAI account when the upstream response matches a status code or its body/message contains any configured keyword.',
      openAIAutoDisableRulesDisabledHint: 'When disabled, matching responses will not auto-disable accounts, but the rules are kept.',
      openAIAutoDisableRulesRules: 'Rules',
      openAIAutoDisableRulesEmpty: 'No rules yet. Add one to get started.',
      openAIAutoDisableRulesAdd: 'Add Rule',
      openAIAutoDisableRulesRemove: 'Remove',
      openAIAutoDisableRulesStatusCode: 'Status Code',
      openAIAutoDisableRulesStatusCodePlaceholder: 'e.g. 401',
      openAIAutoDisableRulesKeywords: 'Message Keywords',
      openAIAutoDisableRulesKeywordsPlaceholder: 'e.g. token_revoked, invalidated oauth token',
      openAIAutoDisableRulesKeywordsHint: 'Separate keywords with commas or new lines. Either a matching status code or a matching keyword will trigger auto-disable.',
      openAIAutoDisableRulesDescription: 'Description',
      openAIAutoDisableRulesDescriptionPlaceholder: 'Optional note for this rule',
      openAIAutoDisableRulesLoadFailed: 'Failed to load OpenAI auto disable rules',
      openAIAutoDisableRulesSave: 'Save Rules',
      openAIAutoDisableRulesSaving: 'Saving...',
      openAIAutoDisableRulesSaved: 'OpenAI auto disable rules saved',
      openAIAutoDisableRulesSaveFailed: 'Failed to save OpenAI auto disable rules',
      openAIAutoDisableRulesInvalid: 'Please enter at least one status code or keyword',
      batchRefreshPendingOpenAI: 'Refresh Pending OAI',
      batchRefreshPendingOpenAIHint: 'Refresh all OpenAI OAuth accounts with missing plan info, or Free accounts that still have training sharing enabled',
      batchRefreshPendingOpenAIRefreshing: 'Refreshing pending...',
      batchRefreshPendingOpenAIConfirm: 'This will refresh all OpenAI OAuth accounts with missing plan info, or Free accounts that still have training sharing enabled. Continue?',
      batchRefreshPendingOpenAINone: 'No OpenAI OAuth accounts need this refresh',
      batchRefreshPendingOpenAISuccess: 'Refreshed {count} pending OpenAI OAuth account(s)',
      batchRefreshPendingOpenAIPartial: 'Refresh partially completed: {success} succeeded, {failed} failed',
      batchRefreshPendingOpenAIFailed: 'Failed to refresh pending OpenAI OAuth accounts',
      ...
      openAIAuthImport: 'Import auth.json',
      openAIAuthImportTitle: 'Bulk Import auth.json',
      openAIAuthImportHint: 'Import OpenAI OAuth credentials in bulk through file upload or a JSON-array API payload.',
      openAIAuthImportFormatHint: 'The file or request payload must be a standard JSON array. The example below shows the structure of one record.',
      openAIAuthImportWarning: 'This import does not deduplicate and does not auto-bind default groups. Every record creates a new openai/oauth account and must include refresh_token.',
      openAIAuthImportModeFile: 'File Upload',
      openAIAuthImportModeJson: 'JSON Array',
      openAIAuthImportFile: 'auth.json file',
      openAIAuthImportJson: 'JSON content',
      ...
      openAIAuthImportAccountOptionsTitle: 'Imported Account Settings',
      openAIAuthImportAccountOptionsHint: 'These settings are applied to every OpenAI OAuth account created in this import.',
      openAIAuthImportWSModeDefault: 'Unset (use system default)',
      openAIAuthImportWSModeDefaultHint: 'Leave this unset to preserve the account default behavior. WS mode is written only when you explicitly choose one here.',
      ...
      openAIAuthImportNameTemplatePresetDefault: 'Default naming rule',
      openAIAuthImportNameTemplatePresetEmail: 'Email only: {email}',
      openAIAuthImportNameTemplatePresetPlanEmail: 'Plan-email: {plan_type}-{email}',
      ...
      openAIAuthImportSelectJson: 'Please enter a JSON array',
      openAIAuthImportMustBeArray: 'JSON content must be an array',
      openAIAuthImportParseFailed: 'Failed to parse JSON',
      openAIAuthImportFailed: 'Failed to import auth.json',
      openAIAuthImportResult: 'Import Result',
      openAIAuthImportResultSummary: 'Accounts created {account_created}, failed {account_failed}',
      openAIAuthImportErrors: 'Error Details',
      openAIAuthImportSuccess: 'Import completed: accounts created {account_created}, failed {account_failed}',
      openAIAuthImportCompletedWithErrors: 'Import completed with errors: accounts created {account_created}, failed {account_failed}',
    ...
    usage: {
      ...
      upstreamErrorDetail: 'Upstream Error',
      userVisibleErrorBody: 'User Visible Error',
