export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      openAIAuthImportFormatHint: 'The file or request payload must be a standard JSON array, for example: [{...}, {...}]',
      ...
      openAIAuthImportJsonPlaceholder: '[{\"tokens\":{\"access_token\":\"...\",\"refresh_token\":\"...\",\"id_token\":\"...\",\"account_id\":\"...\"}}]',
