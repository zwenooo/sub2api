...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/status-summary", h.Admin.Account.GetStatusSummary)
		accounts.GET("/risk-overview", h.Admin.Account.GetRiskOverview)
		...
		rules := accounts.Group("/rules")
		{
			rules.GET("", h.Admin.AccountRule.GetCatalog)
			rules.GET("/settings", h.Admin.AccountRule.GetSettings)
			rules.PUT("/settings", h.Admin.AccountRule.UpdateSettings)
			rules.GET("/drafts/from-ops", h.Admin.AccountRule.GetOpsDraft)
			rules.POST("/bindings", h.Admin.AccountRule.CreateBinding)
			rules.PUT("/bindings/:id", h.Admin.AccountRule.UpdateBinding)
			rules.DELETE("/bindings/:id", h.Admin.AccountRule.DeleteBinding)
			rules.POST("/model-collections", h.Admin.AccountRule.CreateModelCollection)
			rules.PUT("/model-collections/:id", h.Admin.AccountRule.UpdateModelCollection)
			rules.DELETE("/model-collections/:id", h.Admin.AccountRule.DeleteModelCollection)
			rules.POST("/error-collections", h.Admin.AccountRule.CreateErrorCollection)
			rules.PUT("/error-collections/:id", h.Admin.AccountRule.UpdateErrorCollection)
			rules.DELETE("/error-collections/:id", h.Admin.AccountRule.DeleteErrorCollection)
			rules.POST("/error-collections/:collectionId/rules", h.Admin.AccountRule.CreateRule)
			rules.PUT("/rules/:id", h.Admin.AccountRule.UpdateRule)
			rules.DELETE("/rules/:id", h.Admin.AccountRule.DeleteRule)
		}
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		// OpenAI 限流恢复自测配置
		adminSettings.GET("/openai-rate-limit-recovery", h.Admin.Setting.GetOpenAIRateLimitRecoverySettings)
		adminSettings.PUT("/openai-rate-limit-recovery", h.Admin.Setting.UpdateOpenAIRateLimitRecoverySettings)
		// 请求整流器配置
