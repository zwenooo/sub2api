...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		rules := accounts.Group("/rules")
		{
			...
			rules.POST("/scopes", h.Admin.AccountRule.CreateScope)
			rules.PUT("/scopes/:id", h.Admin.AccountRule.UpdateScope)
			rules.DELETE("/scopes/:id", h.Admin.AccountRule.DeleteScope)
			rules.POST("/scopes/:scopeId/rules", h.Admin.AccountRule.CreateRule)
